  ...
  transformIndexHtml: {
    ...
    handler: (html) => {
      return html.replace(
        ...
        <meta http-equiv="Content-Security-Policy" content="default-src 'self' ${DEVELOPMENT_NONCE}; img-src 'self' https://uploads.getalby-assets.com https://cdn.getalby-assets.com https://getalby.com; connect-src 'self' https://api.getalby.com https://getalby.com https://zapplanner.albylabs.com wss:; frame-src https://www.youtube-nocookie.com" />`
      );
    },
  },
};
